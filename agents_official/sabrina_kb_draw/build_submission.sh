#!/usr/bin/env bash
# Pack sabrina_kb_draw (Alakazam, prize-belief-aware draw guard) into submission.tar.gz = main.py + deck.csv + cg/ (the local
# engine shipped in this dir). Location-independent. Usage:  bash build_submission.sh
set -euo pipefail
