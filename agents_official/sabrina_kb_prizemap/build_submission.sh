#!/usr/bin/env bash
# Pack sabrina_kb_prizemap (Alakazam, adaptive 6-prize prize-map nudge) into submission.tar.gz =
# main.py + deck.csv + cg/ (the local engine shipped in this dir). Location-independent.
