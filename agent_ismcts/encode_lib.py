...
# cg importable: el propio dir del agente trae un cg/ sibling. Anadimos su dir (y rutas conocidas) al path.
for _p in (os.path.dirname(os.path.abspath(__file__)),
           "/kaggle_simulations/agent",
           os.path.join(os.path.dirname(__file__), "..", "dragapult_sample"),
